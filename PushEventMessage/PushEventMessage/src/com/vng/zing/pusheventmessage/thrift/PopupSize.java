...
public class PopupSize implements org.apache.thrift.TBase<PopupSize, PopupSize._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PopupSize");
  ...
  static {
    schemes.put(StandardScheme.class, new PopupSizeStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PopupSizeTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.WIDTH,_Fields.HEIGHT};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PopupSize.class, metaDataMap);
  }
   ...
   */
  public PopupSize(PopupSize other) {
    __isset_bitfield = other.__isset_bitfield;
    this.width = other.width;
    this.height = other.height;
  }

  public PopupSize deepCopy() {
    return new PopupSize(this);
  }
  ...
  public PopupSize setWidth(int width) {
    this.width = width;
    setWidthIsSet(true);
    return this;
  }
  ...
  public PopupSize setHeight(int height) {
    this.height = height;
    setHeightIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PopupSize)
      return this.equals((PopupSize)that);
    return false;
  }

  public boolean equals(PopupSize that) {
    if (that == null)
      return false;
  ...
  public int compareTo(PopupSize other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    PopupSize typedOther = (PopupSize)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PopupSize(");
    boolean first = true;
  ...
  private static class PopupSizeStandardSchemeFactory implements SchemeFactory {
    public PopupSizeStandardScheme getScheme() {
      return new PopupSizeStandardScheme();
    }
  }

  private static class PopupSizeStandardScheme extends StandardScheme<PopupSize> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PopupSize struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PopupSize struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PopupSizeTupleSchemeFactory implements SchemeFactory {
    public PopupSizeTupleScheme getScheme() {
      return new PopupSizeTupleScheme();
    }
  }

  private static class PopupSizeTupleScheme extends TupleScheme<PopupSize> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PopupSize struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PopupSize struct) throws org.apache.thrift.TException {
